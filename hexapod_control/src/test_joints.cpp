...
int main(int argc, char **argv)
{
    ...
    const std::string joints_command_topic_name = "leg_joints_command";
    ...
    msg1.left_rear_leg.coxa = 0.f;
    msg1.left_rear_leg.femur = 0.f;
    msg1.left_rear_leg.tibia = 0.f;
    ...
    msg1.right_rear_leg.coxa = 0.f;
    msg1.right_rear_leg.femur = 0.f;
    msg1.right_rear_leg.tibia = 0.f;
    ...
    msg2.left_rear_leg.coxa = 0.f;
    msg2.left_rear_leg.femur = 0.785398f;
    msg2.left_rear_leg.tibia = 0.785398f;
    ...
    msg2.right_rear_leg.coxa = 0.f;
    msg2.right_rear_leg.femur = 0.785398f;
    msg2.right_rear_leg.tibia = 0.785398f;
