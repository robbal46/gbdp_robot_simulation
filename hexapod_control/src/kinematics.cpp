    ...
    for (int i = 0; i < feet_positions.foot.size(); i++) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                break;
            case 2:
                msg.left_rear_leg.coxa = coxa_angle_rad - coxa_angle_offset_rad;
                msg.left_rear_leg.femur = -femur_angle_rad;
                msg.left_rear_leg.tibia = -tibia_angle_rad;
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                msg.right_rear_leg.coxa = coxa_angle_rad + coxa_angle_offset_rad;
                msg.right_rear_leg.femur = -femur_angle_rad;
                msg.right_rear_leg.tibia = -tibia_angle_rad;
                break;
        }
    }
    return msg;
