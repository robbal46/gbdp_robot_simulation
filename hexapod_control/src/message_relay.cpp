...
MessageRelay::MessageRelay(ros::NodeHandle *nh) {
    joints_command_gazebo_publisher_ = nh->advertise<std_msgs::Float64MultiArray>("hexapod_controller/command", 1);
    joints_command_subscriber_ = nh->subscribe("leg_joints_command", 1, &MessageRelay::send_to_joint_group_position_callback, this);
}
...
void MessageRelay::send_to_joint_group_position_callback(const hexapod_msgs::LegsJoints::ConstPtr &legs_joints) {
    ...
    joint_array_rad.data[6] = 0 - legs_joints->left_rear_leg.coxa;
    joint_array_rad.data[7] = 0 - legs_joints->left_rear_leg.femur;
    joint_array_rad.data[8] = 0 - legs_joints->left_rear_leg.tibia;
    ...
    joint_array_rad.data[15] = legs_joints->right_rear_leg.coxa;
    joint_array_rad.data[16] = legs_joints->right_rear_leg.femur;
    joint_array_rad.data[17] = legs_joints->right_rear_leg.tibia;
