...
import rospy
import math
from hexapod_gazebo.hexapod import Hexapod
from geometry_msgs.msg import Twist


jleg = ['coxa_joint', 'thigh_joint', 'tibia_joint']
sides = ['l', 'r']
suffix = ['f', 'm', 'r']
joints = []
for j in jleg:
...
class WFunc:
    ...
    def generate(self):
        ...
        self.set_func('thigh_joint', f1, f2)
...
class Walker:
    ...
    def __init__(self, darwin):
        ...
        self.ready_pos = self.func.get(True, 1, [0, 0, 0])
    ...
    def update_velocity(self, target, n):
        a = 3 / float(n)
        b = 1 - a
        t_and_v = list(zip(target, self.current_velocity))
